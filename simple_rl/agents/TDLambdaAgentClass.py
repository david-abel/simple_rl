''' TDLambdaAgentClass.py: Class for a basic TDLambdaAgent '''
...
class TDLambdaAgent(Agent):
    ''' Implementation for a TD Lambda Agent '''

    def __init__(self, actions, name="TD-lambda", alpha=0.1, gamma=0.99, lambd=0.7):
        '''
        Args:
